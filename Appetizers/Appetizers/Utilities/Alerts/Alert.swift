...
//  Appetizers
//
//  Created by Jie Huang on 2023/9/9.
//
...
struct AlertContext {
    ...
    static let unableToComplete = AlertItem(title: Text("Server Error"), message: Text("Unable to complete your request for this time. Please check your internet connection"), dismissButton: .default(Text("OK")))
    ...
    static let userSaveSuccess = AlertItem(title: Text("Profile Saved"), message: Text("Your profile information has successfully saved."), dismissButton: .default(Text("OK")))
